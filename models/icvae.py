...
class ICVAE(lg.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        lr_scheduler = optim.lr_scheduler.LinearLR(optimizer, start_factor=1.0, end_factor=1/3.,
    ...
    def _loss(self, recon_x, x, mu, logvar, mode='train'):
        ...
        if self.hparams.conditional_dim > 0:
            mu_32, logvar_32 = mu.float(), logvar.float()
            marginal_loss = pairwise_gaussian_kl(mu_32, logvar_32, self.hparams.latent_dim).mean()
